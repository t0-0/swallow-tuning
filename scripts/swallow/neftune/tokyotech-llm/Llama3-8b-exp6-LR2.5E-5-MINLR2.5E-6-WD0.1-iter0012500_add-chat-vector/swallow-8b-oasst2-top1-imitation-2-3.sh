...
TOKENIZER_DIR=tokyotech-llm/Llama3-8b-exp6-LR2.5E-5-MINLR2.5E-6-WD0.1-iter0012500_add-chat-vector
CHECKPOINT_DIR=tokyotech-llm/Llama3-8b-exp6-LR2.5E-5-MINLR2.5E-6-WD0.1-iter0012500_add-chat-vector
CHECKPOINT_SAVE_DIR="/groups/gag51395/acf15833kg/checkpoints/Llama3-8b-exp6-LR2.5E-5-MINLR2.5E-6-WD0.1-iter0012500_add-chat-vector-instruct-v1-NEFTune-fix/oasst2-top1-imitation-2-3-lr_${LR}-minlr_${MIN_LR}-GB_${GLOBAL_BATCH_SIZE}"
...
# job name
JOB_NAME="Llama3-8b-exp6-LR2.5E-5-MINLR2.5E-6-WD0.1-iter0012500_add-chat-vector-instruct-v1-NEFTune-oasst2-top1-imitation-2-3-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}"

export WANDB_ENTITY="prj-jalm"
export WANDB_PROJECT="Llama-3-8b-instruct"
