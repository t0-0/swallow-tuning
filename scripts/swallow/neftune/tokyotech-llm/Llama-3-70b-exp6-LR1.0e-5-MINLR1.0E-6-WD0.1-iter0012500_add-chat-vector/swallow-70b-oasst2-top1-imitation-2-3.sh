...
CHECKPOINT_SAVE_DIR="/groups/gag51395/acf15833kg/checkpoints/Llama-3-70b-exp6-LR1.0e-5-MINLR1.0E-6-WD0.1-iter0012500_add-chat-vector-instruct-v1-NEFTune/oasst2-top1-imitation-2-3-lr_${LR}-minlr_${MIN_LR}-GB_${GLOBAL_BATCH_SIZE}"
...
# job name
JOB_NAME="Llama-3-70b-exp6-LR1.0e-5-MINLR1.0E-6-WD0.1-iter0012500_add-chat-vector-instruct-v1-NEFTune-oasst2-top1-imitation-2-3-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}"
