...
CHECKPOINT_SAVE_DIR="/groups/gaf51217/acf15833kg/swallow-project/checkpoints/finetuning/Swallow-7b-VE-instruct-v1.0/ichikara-lr_${LR}-minlr_${MIN_LR}-GB${GLOBAL_BATCH_SIZE}_iter${ITERATIONS}"
...
# job name
JOB_NAME="Swallow-7b-VE-instruct-ichikara-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}-ITERATIONS=${ITERATIONS}"
