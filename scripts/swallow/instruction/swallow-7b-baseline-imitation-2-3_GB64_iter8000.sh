...
CHECKPOINT_SAVE_DIR="/groups/gaf51217/acf15833kg/swallow-project/checkpoints/finetuning/Swallow-7b-VE-instruct-v1.0/baseline-imitation-2-3-lr_${LR}-minlr_${MIN_LR}-GB${GLOBAL_BATCH_SIZE}_iter${ITERATIONS}"
