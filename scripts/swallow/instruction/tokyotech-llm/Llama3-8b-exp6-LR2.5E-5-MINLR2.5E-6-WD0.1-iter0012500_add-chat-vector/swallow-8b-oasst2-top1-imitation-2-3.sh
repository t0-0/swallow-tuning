...
CHECKPOINT_SAVE_DIR="/groups/gag51395/acf15833kg/checkpoints/Llama3-8b-exp6-LR2.5E-5-MINLR2.5E-6-WD0.1-iter0012500_add-chat-vector-instruct-fix/oasst2-top1-imitation-2-3-lr_${LR}-minlr_${MIN_LR}-GB_${GLOBAL_BATCH_SIZE}"
...
# job name
JOB_NAME="Llama3-8b-exp6-LR2.5E-5-MINLR2.5E-6-WD0.1-iter0012500_add-chat-vector-instruct-oasst2-top1-imitation-2-3-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}"
