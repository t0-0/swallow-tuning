...
CHECKPOINT_SAVE_DIR="/groups/gaf51217/acf15833kg/swallow-project/checkpoints/finetuning/Swallow-7b-VE-instruct-v1.0/gpt-4-self-instrct-lr_${LR}-minlr_${MIN_LR}-GB${GLOBAL_BATCH_SIZE}_iter${ITERATIONS}"

mkdir -p ${CHECKPOINT_SAVE_DIR}

# dataset
DATASET_DIR=/bb/llm/gaf51275/llama/finetuning/datasets/training/gpt-4-self-instrct
...
# job name
JOB_NAME="Swallow-7b-VE-instruct-gpt-4-self-instrct-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}-ITERATIONS=${ITERATIONS}"
