...
CHECKPOINT_SAVE_DIR="/groups/gcc50623/acf15833kg/swallow-project/checkpoints/finetuning/Swallow-7b-VE-instruct-v1.0/baseline-ichikara-lr_${LR}-minlr_${MIN_LR}-GB${GLOBAL_BATCH_SIZE}_iter${ITERATIONS}"

mkdir -p ${CHECKPOINT_SAVE_DIR}

# dataset
DATASET_DIR=/bb/llm/gaf51275/llama/finetuning/datasets/training/baseline-ichikara
...
# job name
JOB_NAME="Swallow-7b-VE-instruct-baseline-ichikara-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}-ITERATIONS=${ITERATIONS}"
